...
int main(){
    ...
    setName(s, "Tifany");
    setSubject(s, "TIF");
    setViveuEm(s,"Crespos");
    setDescription(s,"Person");
    setDescription(s,"cute");
    setCasouCom(s,"Gui");
    ...
    setSubject(s1, "UI");
    setViveuEm(s1,"Braga");
    setDescription(s1,"Person");
    setDescription(s1,"cute");
    setCasouCom(s1,"Tifany");
    ...
    setSubject(s2, "UI");
    setViveuEm(s2,"Braga");
    setDescription(s2,"Person");
    setDescription(s2,"cute");
    setCasouCom(s2,"Tifany");
    //insertSubject(&s,&s2);
    //printSubject(s);
